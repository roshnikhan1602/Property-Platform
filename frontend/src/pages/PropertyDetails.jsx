          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6 lg:p-7 min-w-0">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4 sm:gap-5">
              ...
              <button
                type="button"
                onClick={handleShare}
                className="border border-gray-200 hover:border-blue-300 hover:bg-blue-50 px-4 py-2 rounded-lg text-sm font-medium text-gray-700 transition flex items-center gap-2 flex-shrink-0"
              >
